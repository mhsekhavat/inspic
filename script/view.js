(function($) {
	...
	appendTo('#inspic_caption')(
		...
		subscribe: {
			...
			var $el=this.$('.iconSelect').removeClass("posTop posBottom");
			$el.addClass(vpos == 'top' ? 'posTop' : 'posBottom');
		    }
		}
	    })
	)(
